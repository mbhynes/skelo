...
The `skelo <https://pypi.org/project/skelo/>`_ package is a simple implementation suitable for small-scale rating systems that fit into memory on a single machine.
